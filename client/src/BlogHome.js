...
function BlogHome(props) {
  ...
  return (
      <div className="flex-row grid grid-cols-5">
         <div className="ml-4 text-blue-200 font-roboto hidden md:block">
         ...
         <div className="text-blue-200 font-roboto pt-10 sm:mx-5 md:pl-20 md:pr-0 md:col-span-3 col-span-5">
          <Switch>
