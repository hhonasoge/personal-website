...
function MyEditor(props) {
  ...
  return data.isauthed ? (
    <div className="border border-solid border-black m-4">
      ...
      <div className="flex">
        <input
          className="text-black m-auto rounded-full p-2 w-1/2 mb-5"
          placeholder="Title"
          name="title"
      ...
      <div className="flex">
        <input
          className="text-black m-auto rounded-full p-2 w-1/2"
      ...
      <div className="flex">
        <button
          className="text-black m-auto rounded-full p-2 bg-blue-200 hover:bg-blue-300 mb-2"
          type="submit"
          name="button"
